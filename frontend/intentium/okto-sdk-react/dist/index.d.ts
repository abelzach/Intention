...
declare const OktoProvider: ({ children, apiKey, buildType, gAuthCb, primaryAuth, brandData, }: {
    children: ReactNode;
    apiKey: string;
    buildType: BuildType;
