import React, { useRef, useEffect, forwardRef, useState, useImperativeHandle, useMemo, createContext, useContext } from 'react';
    ...
    return (React.createElement("div", { className: `${styles.modalOverlay} ${currentScreen ? "" : styles.hidden}`, onClick: handleClose },
        React.createElement("div", { className: styles.modalContainer },
            React.createElement("div", { className: styles.modalContent },
                React.createElement("div", { className: styles.container }, currentScreen === ModalType.WIDGET && (React.createElement(WidgetIframe, { modalData: modalData, onClose: handleClose })))))));
};
const OktoModal = forwardRef(_OktoModal);
...
const OnboardingIframe = ({ visible, onClose, updateAuthCb, gAuthCb, buildType, apiKey, brandData, primaryAuth, theme, }) => {
    ...
    const iframeKey = useMemo(() => btoa(encodeURIComponent(JSON.stringify({
        buildType,
        apiKey,
        brandData,
        primaryAuth,
...
const OnboardingModal = forwardRef(_OnboardingModal);

const OktoContext = createContext(null);
const OktoProvider = ({ children, apiKey, buildType, gAuthCb, primaryAuth = AuthType.EMAIL, brandData = defaultBrandData, }) => {
    const oktoModalRef = useRef(null);
...
const useOkto = () => useContext(OktoContext);

export { AuthType, BuildType, ModalType, OktoProvider, OrderStatus, useOkto };
